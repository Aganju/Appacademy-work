...
ActiveRecord::Schema.define(version: 20170720160747) do
  ...
  add_index "responses", ["answer_choice_id", "responder_id"], name: "index_responses_on_answer_choice_id_and_responder_id", using: :btree
